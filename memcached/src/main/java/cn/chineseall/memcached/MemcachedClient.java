...
/**
 * Schooner light-weight memcached client. It is of higher performance than other java memcached clients. The main
 * modification is done by Xingen Wang.<br>
 * <br>
 * Instead of the InputStream and OutputStream, we choose the SocketChannel and java.nio package to increase the
 * performance.<br>
...
public class MemcachedClient {
    ...
    // logger
    public static Logger log = Logger.getLogger(MemcachedClient.class);
    ...
    public static final int COMPRESS_THRESH = 1024 * 1000;// 1M
     ...
     * The reason for use this that we have to put the size of the object bytes into the command line. While as a matter
     * of fact, we can't get the real size before we completed the serialization.<br>
     * In order to solve this problem, we add this blank area to the size position in the command line. When we complete
     * the full serialization and get the bytes size, we will replace this blank are with real bytes size.<br>
     * This definitely help us decrease the GC of JVM.
     */
    public final byte[] BLAND_DATA_SIZE = "        ".getBytes();
    public final byte[] BLAND_FLAG = "    ".getBytes();
     ...
     *             Please use customized transcoder {@link com.schooner.MemCached.AbstractTransCoder} to achieve the
     *             same objective.
     */
    @Deprecated
     ...
     * 
     * @param errorHandler
     * @deprecated will be removed in next release. The purpose of adding this support was to make it compatible with
     *             previous releases.
     */
    ...
    public void setCompressEnable(boolean compressEnable) {
        // don't throw Exception to avoid startup fail
    ...
    public void setCompressThreshold(long compressThreshold) {
        // dont't throw Exception to avoid startup fail
