...
<div class="crumbs">
	<a href="">首页</a> &gt; <a href="">内容管理</a> &gt; 修改新闻
</div>
<div class="context">
	<form id="updateNewsForm" action="/manage/content/updateNews.action" method="POST">
		<input type="hidden" name="currentPage" value="${currentPage!1}"/>
		<input type="hidden" name="id" value="${orgNews.id!1}"/>
		
		<table class="formTable" cellpadding="5" cellspacing="0" width="100%">
			<tr>
				<th width="100"><span class="red">*</span>标题：</th><td>
				<input class="text" id="title" name="title" value="${orgNews.title!''}" type="text" />
				<span class="info"></span></td>
			</tr>
			<tr>
				<th width="100"><span class="red"></span>内容：</th><td>
				<textarea id="editor" name="content">${orgNews.content!''}</textarea>
				<script>
		     		var editor;
			...
			<tr>
				...
				<input class="text" name="contentSource" value="${orgNews.contentSource!''}" type="text" />
				<span class="info"></span></td>
			</tr>
			<tr>
				<th width="100"><span class="red"></span>跳转链接：</th><td>
				<input class="text" name="linkUrl" value="${orgNews.linkUrl!''}" type="text" />
