...
<dl class="tabjs">
	<dt class="tit">
		<div class="tabTitTag">
			<a href="/user/${visitUser.userId}/concern.action" class="hot" >TA关注的书友</a><a href="/user/${visitUser.userId}/concernhere.action" >关注他TA的书友</a>
		</div>
	</dt>
	<dd class="BookFriend">
		<div class="other">
			<span class="info">TA正在关注的人：（全部${count?default(0)}人）</span>
		</div>
		<#if (list?? && list?size > 0) >
		<dl class="listIsilo" >
			<#list list as u>
		...
		<form id="p" method="get" action="concern.action" >
